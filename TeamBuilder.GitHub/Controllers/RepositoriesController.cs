...
public class RepositoriesController : ControllerBase
{
    ...
    public async Task<IActionResult> GetRepositoriesAsync()
    {
        ...
        var repos = await client.Organization.Team.GetAllRepositories(_factory.TeamId);
    ...
    public async Task<IActionResult> CreateRepositoryAsync([FromBody] CreateRepositoryRequest request)
    {
        var client = await _factory.GetClientAsync();
